...
function Bot() {  
  ...
  let largura = "45px";
  let altura  = "30px";
  let bodyBot =  "<div id='bot'><button id='close' value='0'>><div id ='chidBot'></button><input id='messageUser' value='Link para perguntas:'></input><button id='quantMessage'>+1</button><button id='onBot'>Start</button><button id='offBot'>Stop</button></div></div>"
  ...
  function blenBot(quantMessage,desableBot, userMessage) {
    ...
    function blenMessage() 
    {
      ...
      if(sizeOfNewMessages >= window.dp6.sendAfter) {
        ...
        window.dp6.btnSendMessage  = document.querySelector('#ow3 .T4LgNb .crqnQb .R3Gmyc.qwU8Me .hWX4r .BC4V9b span button');
